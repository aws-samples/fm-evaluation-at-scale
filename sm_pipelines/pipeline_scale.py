...
if __name__ == "__main__":
    ...
    best_model_id = step(selection, name="model_selection")(*evaluation_results_all)
    ...
    for model_config in config["models"]:
        if model_config["cleanup_endpoint"]:
            ...
            get_step(cleanup_step).add_depends_on([best_model_id])
            last_pipeline_step.append(cleanup_step)

    if len(last_pipeline_step) == 0:
        last_pipeline_step.append(best_model_id)
